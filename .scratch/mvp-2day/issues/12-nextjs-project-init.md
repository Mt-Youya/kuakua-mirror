...
**What to build:** 在项目根目录创建 Next.js 前端项目（目录名：`web/`），配置 TypeScript、Tailwind CSS、shadcn/ui 组件库。创建基本的页面结构和路由。
...
- [ ] 运行 `npx create-next-app@latest web` 创建项目（选择 TypeScript, Tailwind CSS, App Router）
